...
export const promptAuth = async (suryaClient: SuryaClient, generateTokenLink: string): Promise<string> => {
...
export const loginByRoomOTP = async (suryaClient: SuryaClient, roomId: string) => {
...
export const resumeSession = async (env: env, suryaClient: SuryaClient, roomId?: string): Promise<User | null> => {
